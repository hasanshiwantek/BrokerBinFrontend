...
//     const {inventorySearchData} = useSelector((store) => store.inventoryStore);
//     console.log("Inventory Search Data:", inventorySearchData);
//     const searchRzltPartModels=inventorySearchData.data?.map((val)=>val.partModel);
//     console.log(searchRzltPartModels)
...
const InventorySearchResult = () => {
    ...
    const fetchPageData = async (newPage) => {
        ...
        try {
            ...
            const result = await dispatch(inventorySearch({ data: updatedFilters, token })).unwrap();
                ...
                <table>
                    ...
                    <tbody>
                        {searchResults?.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="15">
                                    <h1 className="text-red-700 text-center font-bold">No Result Found</h1>
                                </td>
                            </tr>
                        )}
                    </tbody>
                ...
                <div className="mt-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                        <button
                            ...
                            className={`px-4 py-2 bg-blue-500 text-white rounded-md mx-1 ${visiblePages[0] === 1 ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-600"
                                }`}

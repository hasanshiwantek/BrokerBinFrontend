...
const MyProfile = () => {
  ...
  const textAreaContent = [
    ...
    formData.sigcheckPhone ? `${formData.directNumber}` : "",
          ...
          <div className={css.profileInfo}>
            ...
            <div className={css.profileInfo_form}>
              ...
              <div className={css.profileInfo_form_phone}>
                ...
                <div>
                  <span>
                    <label htmlFor="directNumber">Direct Number</label>
                    <input
                      type="text"
                      name="directNumber"
                      id="directNumber"
              ...
              <div className={css.profileInfo_form_signature}>
                ...
                <p>Uncheck Use Custom Signature to use the checkboxes above.</p>
              </div>

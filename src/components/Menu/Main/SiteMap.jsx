                    ...
                    <div className='sections'>
                        <div id="box1">
                            <ul>
                                ...
                                <Link to={"/"}>
                                    <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Home</li>
                                </Link>
                                <Link to={"/help"}>
                                    <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Help</li>
                                </Link>
                                <Link to={"/feedback"}>
                                    <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Contact</li>
                                </Link>
                                <Link to={"/sitemap"}>
                                    <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Site Map</li>
                                </Link>
                            </ul>
                        </div>
                        <div id="box2">
                        ...
                        <div id="box4">
                            <ul>
                                ...
                                <Link to={"/inventory"}> <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Manage Inventory</li></Link>
                                <Link to={"/inventory/Upload"}>  <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Upload</li></Link>
                               ...
                               <Link> <li style={{ marginLeft: "14px" }}><img src={siteIcon} alt="icon" /> Auto updated settings</li></Link> */}
                                <Link to={"/inventory/Edit-Delete"}> <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Edit</li></Link>
                                <Link to={"/inventory/Add"}> <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Add</li></Link>
                        ...
                        <div id="box6">
                            <ul>
                                ...
                                <Link to={"/sendbroad"}> <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Send Broadcast</li></Link>
                                <Link to={"/broadcasts"}>  <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> View</li></Link>
                                <Link to={"/broadcasts"}> <li style={{ marginLeft: "30px" }}><img src={siteIcon} alt="icon" /> Want to buy</li></Link>
                                <Link to={"/broadcasts"}> <li style={{ marginLeft: "30px" }}><img src={siteIcon} alt="icon" /> Want to sell</li></Link>

                                <Link to={"/myprofile/broadcastfilter"}> <li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> Set Filters</li></Link>
                                <Link to={"/broadcasthistory"}><li style={{ marginLeft: "20px" }}><img src={siteIcon} alt="icon" /> History</li></Link>
                            </ul>
                        </div>
                        <div id="box7">

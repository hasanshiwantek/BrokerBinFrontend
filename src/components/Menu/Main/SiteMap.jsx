                    ...
                    <div className='sections'>
                        ...
                        <div id="box4">
                         ...
                         <li><img src={siteIcon} alt="icon" /> Manage</li>
                              ...
                              <Link to={"/inventory/Upload"}>  <li style={{ marginLeft: "16px" }}><img src={siteIcon} alt="icon" /> Upload</li></Link>
                               ...
                               <Link to={"/myprofile/MyContact"}> <li><img src={siteIcon} alt="icon" /> My Vendors</li></Link>
                        ...
                        <div id="box5">
                            <ul>
                               ...
                               <Link  to={"/broadcasts"}> <li  style={{ marginLeft: "14px" }}><img src={siteIcon} alt="icon" /> Want To Sell</li></Link>
                               ...
                               <Link to={"/myprofile/MyContact"}> <li  tyle={{ marginLeft: "14px" }}><img src={siteIcon} alt="icon" /> show My Vendors</li></Link>
                            ...
                            <ul>
                              ...
                              <Link to={"/broadcasts"}>  <li style={{ marginLeft: "14px" }}><img src={siteIcon} alt="icon" /> View</li></Link>
                               ...
                               <Link to={"/myprofile/broadcastfilter"}> <li style={{ marginLeft: "14px" }}><img src={siteIcon} alt="icon" /> Set Filters</li></Link>
                                <Link to={"/broadcasthistory"}><li style={{ marginLeft: "14px" }}><img src={siteIcon} alt="icon" /> History</li></Link>
                            </ul>
                        </div>
                        <div id="box7">
                            <ul>

      ...
      <div style={{ padding: '15px' }}>
        ...
        <div className="icons-links-sec icons-box box">
            ...
            <div className='icons-link-sec'>
              ...
              <span>Hot List, click on it to view items you want to track daily</span>
            </div>
            ...
            <div className='icons-link-sec'>
              ...
              <span>Allows you to add or remove companies from your MyVendors List</span>
            </div>

            <div className='icons-link-sec'>
              <img src={icon4} alt="Contacts" />
              <span>Allows you to add or remove individuals from your My Contacts List</span>
            </div>
            ...
            <div className='icons-link-sec'>
              ...
              <span>Match Your Hits allows for quick access to these reports</span>
            </div>

...
//         return `- ------------------ -</br>
//         ${broadcast?.user_id?.firstName || ''} ${broadcast?.user_id?.lastName || ''}</br>
//         ${broadcast?.user_id?.company?.name || ''}</br>
//         P: ${broadcast?.user_id?.phoneNumber || ''}</br>
//         ${broadcast?.user_id?.email || ''}</br>

//         - ------------------ -</br>
//         Original Broadcast Details</br>
//         MFG: ${broadcast?.mfg || ''}</br>
//         Part No: ${broadcast?.partModel || ''}</br>
//         Condition: ${broadcast?.cond || ''}</br>
//         Quantity: ${broadcast?.quantity || ''}</br>
//         Price: ${broadcast?.price || ''}</br>
//         Comments: ${broadcast?.additional_comments || ''}</br>
//         Description: ${broadcast?.description || ''}</br>
//         `;
//     };
...
//                     <button type="submit" className={styles.sendButton} onClick={handleSubmit }>Send</button>
//                     <button
//                         type="button"

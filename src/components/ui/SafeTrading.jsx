...
const SafeTrading = () => {
    return (
        <>
            ...
            <div className="bg-white shadow-lg rounded-lg p-8 max-w-6xl w-full mx-auto mt-24 border border-gray-300 text-[#444]">
                {/* Header */}
                ...
                <div className={`${css.safeTradingContainer} grid md:grid-cols-3 gap-5 mt-16 `}>
                    ...
                    <div>
                        ...
                        <ol className="list-decimal list-inside  space-y-1 font-normal">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mt-8">
                            ...
                            <div >
                                ...
                                <ol className="list-decimal list-inside  space-y-1 whitespace-nowrap">
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside text-[8pt] space-y-1">
        ...
        <div className="border  max-w-6xl w-full mx-auto border-gray-300 rounded-lg p-4  items-center mt-4 grid md:grid-cols-3 gap-5 ">
